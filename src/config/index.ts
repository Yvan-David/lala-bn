...
export const DOCKER_POSTGRES_PORT = parseInt(
  process.env.DOCKER_POSTGRES_PORT as string,
  10,
)
export const DOCKER_LOCAL_PORT = parseInt(process.env.DOCKER_LOCAL_PORT as string, 10)
...
export const NODEMAILER_EMAIL_PORT = parseInt(
  process.env.NODEMAILER_EMAIL_PORT as string,
  10,
)
...
export const SLAT_ROUNDS = parseInt(process.env.SLAT_ROUND as string, 10) || 10
